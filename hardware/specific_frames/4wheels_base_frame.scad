...
module side_4wheels_base_frame(motorWidthSpacing=4WheelsFrameWidthSpacing, motorLengthSpacing=4WheelsFrameLengthSpacing, middleBarWidth=OlloSegmentWidth, nLayer=1) {
...
module 4wheels_base_frame(motorWidthSpacing=4WheelsFrameWidthSpacing, motorLengthSpacing=4WheelsFrameLengthSpacing, middleBarWidth=OlloSegmentWidth, nLayer=1) {
